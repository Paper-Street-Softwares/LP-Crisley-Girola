...
export const infos = {
  name: "Dra. Cryslei Girola ",
  email: "contato", // Email desejado pelo cliente
  emailSecundario: "A_Definir", // Email desejado pelo cliente
  domain: "meudireitonasaude.com.br", // Sem "www"
  phone: {
    ddd: "48",
    firstPart: "99904", // Apenas os 5 primeiros números (incluindo o 9)
    secondPart: "1061", // Apenas os 4 últimos números
  },
  phoneSecundario: {
    ddd: "A_Definir",
  ...
  expediente: (
    <div>
      ...
      <p>13h às 18h</p>
      <br />
      <p>PLANTÃO 24H PARA URGÊNCIAS</p>
    </div>
  ),
...
const content = {
  texts: {
    ...
    hero: {
      miniTag: "ADVOGADA NA ÁREA DE SAÚDE EM SANTA CATARINA",
      title: (
        <h1 className="mb-[16px]">
          A saúde não
          <span className="text-primary"> pode esperar</span>
        </h1>
      ),
      subtitle:
        "Quando o direito é negado, a estratégia jurídica precisa agir.",
      ...
      obsHero: {
        ...
        text: "Atuação exclusiva e especializada em Direito Médico e da Saúde",
      },
      ctaButtonAriaLabel:
    ...
    features: {
      miniTag: "SOLUÇÕES JURÍDICAS ESPECIALIZADAS",
      title: "Assessoria Estratégica para Empresas e Profissionais",
      subtitle:
        "Atuação preventiva e corretiva para proteger seus interesses, garantir conformidade e resolver impasses jurídicos com agilidade.",
      imgFeatures: imgFeatures,
      imgDivisor: imgDivisor,
      card1: {
        img: featuresImg1,
        title: "Apoio jurídico perante conselhos",
        subtitle: "Defesa e orientação em processos nos conselhos.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card2: {
        img: featuresImg2,
        title: "Redução de Glosas",
        subtitle: "Até 70% de redução através de contestação técnica.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card3: {
        ...
        subtitle: "Análise e ajuste de cláusulas para sua proteção.",
        description: (
          <div>
            A_Definir <br />
            <br />
      ...
      card4: {
        img: featuresImg4,
        title: "Compliance Preventivo",
        subtitle: "Estruturação de regras para evitar sanções legais.",
        description: (
          <div>
            A_Definir
            <br />
